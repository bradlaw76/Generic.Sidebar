# Generic Sidebar for Dynamics 365 — Release v1.0.0.7
...
### Core Runtime Package Alignment
...
1. Download `GenericSidebar_1_0_0_7.zip` from this repository.
2. Import the unmanaged solution into your Dynamics 365 environment.
