...
- Released the aligned Generic Sidebar Core runtime package as `GenericSidebar_1_0_0_7.zip`.
...
- Strengthened package verification to require byte-for-byte source and packaged web-resource identity.
- Removed the superseded `GenericSidebar_1_0_0_6.zip` release artifact.

## 1.0.0.6 - 2026-08-30

- Aligned the packaged schema and canonical Core runtime for one through four configured panels.
